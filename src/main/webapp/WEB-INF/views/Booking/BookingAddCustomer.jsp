...
<head>
	...
	<meta charset="UTF-8">
	<title>Step2-dodaj klienta</title>
	<style type="text/css">
	...
	<div class="jumbotron">
		<div class="container">
			<div class="row justify-content-center align-items-center" style="height:70vh">
				<div class="col-md-8">
					<div class="card">
						<div class="card-header">Dodaj klienta</div>
						 	<div class="card-body">
							 	<form:form action="${pageContext.request.contextPath}/booking/step2/addCustomer" method="post" modelAttribute="User">

	...
	<div class="jumbotron">
		<div class="cotainer">
			<div class="row justify-content-center align-items-center" style="height:100vh">
				<div class="col-md-8">
					<div class="card">
						<div class="card-header">Dodaj część</div>
						 <div class="card-body">
						 	<form:form action="add" method="post" modelAttribute="carPart">
						 		<form:hidden path="id"/>
						 			...
						 			<div class="col-md-6 offset-md-4">
	         							<input type="submit" value="Zatwierdź" data-toggle="modal" data-target=".bd-example-modal-lg"/>
	            					</div>
						 		</form:form>
						 </div>
					</div>
